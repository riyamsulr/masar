      ...
      <?php
        ...
        if ($result = mysqli_query($connection,$quizInfo)){
          if ($row = mysqli_fetch_assoc($result)){
            echo '<div class="meta-box"><strong>الموضوع</strong><div>'.$row['topicName'].'</div></div>';
            echo '<div class="meta-box"><strong>المعلّم</strong><div>'.$row['firstName'].' '.$row['lastName'].'</div></div>';
                ...
                <?php
                  ...
                  if ($result = mysqli_query($connection, $randquestions)) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo '<div class="q-title">'.$qtext.'</div>';
                      ...
                      echo '<li><label><input type="radio" name="'.$name.'" value="A" required> '.$a.'</label></li>';
                      echo '<li><label><input type="radio" name="'.$name.'" value="B"> '.$b.'</label></li>';
                      echo '<li><label><input type="radio" name="'.$name.'" value="C"> '.$c.'</label></li>';
                      echo '<li><label><input type="radio" name="'.$name.'" value="D"> '.$d.'</label></li>';
